...
>
> **📦 Offline Deployment**: For offline or air-gapped environments, see the [Deployment Guide](./docs/DEPLOYMENT_GUIDE.md) for instructions on pre-installing all dependencies and cache files.
...
- **[Architecture Guide](./docs/ARCHITECTURE.md)** - Learn about the Split-Node and Sequence-First architecture and the Max-Sequence retrieval algorithm
- **[Temporal Guide](./docs/TEMPORAL.md)** - Versioning, time-travel queries, and the `temporal` query mode API reference
- **[User Guide](./docs/USER_GUIDE.md)** - Step-by-step instructions for staging and querying

### Additional Resources

- **[Deployment Guide](./docs/DEPLOYMENT_GUIDE.md)** - Local, Docker, and Kubernetes deployment, including air-gapped setups
- **[Docker Deployment](./docs/DockerDeployment.md)** - Container deployment instructions
- **[Getting Started](./docs/GETTING_STARTED.md)** - Installation, setup, and frontend development guide
- **[Full documentation index](./docs/README.md)** - All guides in one place
