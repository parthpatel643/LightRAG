...
from generate_token import provide_bearer_token
...
@wrap_embedding_func_with_attrs(
    embedding_dim=int(os.getenv("EMBEDDING_DIM", "3072")), max_token_size=8192, model_name=os.getenv("EMBEDDING_MODEL")
)
