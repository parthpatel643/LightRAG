...
async def main():
    ...
    try:
        ...
        print(f"  Graph Storage: NeptuneOpenSearchGraphStorage")
        print(f"  KV Storage: default (JsonKVStorage)")
        print(f"  Vector Storage: default (NanoVectorDBStorage)")
        print(f"  Doc Status Storage: default (JsonDocStatusStorage)")
